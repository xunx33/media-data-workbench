...
function buildAiReviewSystemPrompt(periodLabel, monthsText, withAccountData) {
  let p = '你是一名资深新媒体数据分析师，根据用户提供的数据表进行分析总结并按结构给出评价和建议。下面是视频平台的数据表。\n' +
    ...
    '- 抖音：算法推荐驱动，完播率是进入更大流量池的核心门槛（完播率高→获得更多推荐），均播时长反映内容吸引力，适合追热点、强节奏、有钩子的内容风格。重点关注完播率与均播时长趋势。\n' +
    '- 快手：社区粘性强，粉丝忠诚度高，老铁文化注重人设和信任感，粉丝增长带来的复购/互动价值高。重点关注粉丝增长趋势与粉丝互动深度（点赞/评论比）。\n' +
